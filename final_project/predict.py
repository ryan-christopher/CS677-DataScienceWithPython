...
bass_train, bass_test = train_test_split(bassdf, test_size = 0.5, train_size = 0.5)
...
tenor_train, tenor_test = train_test_split(tenordf, test_size = 0.5, train_size = 0.5)
...
first_alto_train, first_alto_test = train_test_split(altodf, test_size = 0.25, train_size = 0.75)
...
alto_train, alto_test = train_test_split(altodf, test_size = 0.25, train_size = 0.75)
